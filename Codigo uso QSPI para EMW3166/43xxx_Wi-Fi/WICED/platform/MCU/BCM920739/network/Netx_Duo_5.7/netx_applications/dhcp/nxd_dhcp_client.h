...
#define NX_DHCP_THREAD_PRIORITY         21
#endif

/* Define DHCP timeout between DHCP messages processed. */
#ifdef NX_DHCP_TIME_INTERVAL
...
#define NX_BOOTP_OFFSET_END             300     /* End of BOOTP buffer (NX_DHCP_PACKET_PAYLOAD-(16+20+8)    */
...
#define nx_dhcp_user_option_retrieve    nxe_dhcp_user_option_retrieve
