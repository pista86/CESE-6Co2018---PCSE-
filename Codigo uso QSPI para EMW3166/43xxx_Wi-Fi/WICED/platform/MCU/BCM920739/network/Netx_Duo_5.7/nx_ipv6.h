...
#ifdef LIB_CM4_TX_NX
typedef struct _NX_MPL_OPTION_STRUCT
{
    /* Option type. */
    UCHAR optionType;
...
#if defined(LIB_CM4_TX_NX)
// !TODO RFC7346
#define IPV6_REALM_LOCAL_MCAST    0x00000080
// TD. RFC3306
#define IPV6_LINK_LOCAL_TD_MCAST  0x00000100
#define IPV6_REALM_LOCAL_TD_MCAST 0x00000200
#endif
