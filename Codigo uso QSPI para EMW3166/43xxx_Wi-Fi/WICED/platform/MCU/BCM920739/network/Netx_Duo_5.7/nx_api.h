...
//#include "foundation/threadx/cm4/tx56cortex-m4r/tx_trace.h"

#ifdef LIB_CM4_TX_NX
#include "brcm_tx_thread.h"
...
#define NX_IPv4_MPL_PACKET  (NX_IPv4_PACKET)
...
#if defined(NX_ENABLE_INTERFACE_CAPABILITY) && defined(LIB_CM4_TX_NX)
#define NX_IPv6_ICMP_PACKET  (NX_IPv6_PACKET+8) /*Support EUI-64*/
#define NX_IPv6_MPL_PACKET   (NX_IPv6_PACKET+8)
#else
#define NX_IPv6_ICMP_PACKET  (NX_IPv6_PACKET)
#define NX_IPv6_MPL_PACKET   (NX_IPv6_PACKET)
#endif
...
#define NX_MPL_PACKET         (NX_IPv6_MPL_PACKET + NX_IPSEC_MAX_HEADER_SIZE)
#else
...
#define NX_MPL_PACKET         (NX_IPv4_MPL_PACKET + NX_IPSEC_MAX_HEADER_SIZE)
#endif /* FEATURE_NX_IPV6 */
...
#ifdef LIB_CM4_TX_NX
#ifndef LIB_CM4_TX_DISABLE_ICMPV6_ROUTER_SOLICITATION_PROCESS

#define SEND_RTR_SOLICITATION_INDEFINITELY 0xFFFFFFFF

/* Define the size of the IPv6 6LoWPAN context table. */
#ifndef NX_IPV6_6CO_LIST_TABLE_SIZE
#define NX_IPV6_6CO_LIST_TABLE_SIZE 16
#endif /* NX_IPV6_6CO_LIST_TABLE_SIZE */
...
#define NX_LINK_USER_COMMAND        50 
#define NX_LINK_PTP_SEND            51     /* Values after this value are reserved for application.  */
...
#if defined(NX_ENABLE_INTERFACE_CAPABILITY) && defined(LIB_CM4_TX_NX)
// address len in byte, default of NetX is a 6-byte addr
#define NX_INTERFACE_CAPABILITY_LINK_ADDR_SIZE_MASK  0xF0000000
#define NX_INTERFACE_CAPABILITY_LINK_ADDR_SIZE_6     0x10000000
#define NX_INTERFACE_CAPABILITY_LINK_ADDR_SIZE_8     0x20000000
#define NX_INTERFACE_CAPABILITY_RFC7136              0x00001000
#define NX_INTERFACE_CAPABILITY_PREFIX_ON_LINK       0x00002000 /* Treat all prefixes received in the Prefix Information Option in the RA as on-link. */
#endif
...
#ifdef FEATURE_NX_IPV6
#ifdef LIB_CM4_TX_NX
    UCHAR nx_ipv6_mpl_seed_id[16];
    UCHAR nx_ipv6_mpl_proc_state;
#endif /* LIB_CM4_TX_NX */
#endif /* FEATURE_NX_IPV6 */
} NX_PACKET;
...
#if defined(NX_ENABLE_INTERFACE_CAPABILITY) && defined(LIB_CM4_TX_NX)
    ULONG       nx_interface_non_link_local_iid[2];
#endif
...
#ifdef LIB_CM4_TX_NX
    UCHAR       nx_ipv6_rtr_solicitation_start;
#endif
...
#ifdef LIB_CM4_TX_NX
#ifndef LIB_CM4_TX_DISABLE_ICMPV6_ROUTER_SOLICITATION_PROCESS
    ULONG       nx_ip_icmpv6_rs_received;
#endif
#endif
...
#ifndef LIB_CM4_TX_NX
    TX_THREAD   nx_ip_thread;
#else
    THREAD_t    nx_ip_thread;
#endif
...
#else
    OSAPI_TIMER nx_ip_periodic_timer;
#endif
...
#ifdef LIB_CM4_TX_NX
#ifndef LIB_CM4_TX_DISABLE_ICMPV6_ROUTER_SOLICITATION_PROCESS
    void        (*brcm_icmpv6_rs_receive_callback)(struct NX_IP_STRUCT *ip_ptr, UCHAR *ipv6_header, UCHAR *mac, UCHAR IsNew);
    void        (*brcm_icmpv6_ra_receive_callback)(struct NX_IP_STRUCT *ip_ptr, UCHAR *ipv6_header, void **ptr_array_pio, UCHAR count_pio, void **ptr_array_6co, UCHAR count_6co);
    void        (*brcm_icmpv6_ns_receive_callback)(struct NX_IP_STRUCT *ip_ptr, UCHAR *ipv6_header, void *aro_ptr, ULONG flags);
    void        (*brcm_icmpv6_na_receive_callback)(struct NX_IP_STRUCT *ip_ptr, UCHAR *ipv6_header, void *aro_ptr, ULONG flags);
    void        (*brcm_icmpv6_dst_unreachable_receive_callback)(struct NX_IP_STRUCT *, NX_PACKET *);
#endif
#endif
...
#else
    OSAPI_TIMER nx_ip_fast_periodic_timer;
#endif
...
#ifdef LIB_CM4_TX_NX
#ifndef LIB_CM4_TX_DISABLE_ICMPV6_ROUTER_SOLICITATION_PROCESS
    ULONG       nx_ipv6_6co_valid_lifetime[NX_IPV6_6CO_LIST_TABLE_SIZE];
#endif
#endif
...
#ifdef LIB_CM4_TX_NX
    UCHAR nx_ipv6_mpl_seed_id[16];
    UCHAR nx_ipv6_mpl_flag;
    UCHAR nx_ipv6_mpl_sequence;
    void (*brcm_mpl_receive_callback)(struct NX_IP_STRUCT *ip_ptr, NX_PACKET *packet_ptr, void *option, UCHAR*payload, ULONG payload_length);
#endif
#endif /* FEATURE_NX_IPV6 */
