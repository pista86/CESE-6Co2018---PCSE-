...
#define NX_ICMPV6_DUPLICATE_ADDRESS_REQUEST_TYPE        157 //RFC6775
#define NX_ICMPV6_DUPLICATE_ADDRESS_CONFIRMATION_TYPE   158 //RFC6775
#endif

//IPv6 ND option type
#define ICMPV6_OPTION_TYPE_SRC_LINK_ADDR      1
#define ICMPV6_OPTION_TYPE_TRG_LINK_ADDR      2
#define ICMPV6_OPTION_TYPE_PREFIX_INFO        3 //PIO
#define ICMPV6_OPTION_REDIRECTED_HEADER       4
#define ICMPV6_OPTION_TYPE_MTU                5

#ifdef LIB_CM4_TX_NX

#define ICMPV6_OPTION_TYPE_ARO                33 //RFC6775,6LoWPAN Address Registration Option
#define ICMPV6_OPTION_TYPE_6CO                34 //RFC6775,6LoWPAN Context Option
#define ICMPV6_OPTION_TYPE_ABRO               35 //RFC6775,6LoWPAN Authoritative Border Router Option
#define ICMPV6_OPTION_TYPE_6CIO               36 //RFC7400,6LoWPAN Capability Indication Option (6CIO)
...
#ifdef LIB_CM4_TX_NX
/*RFC4861, 4.6.2*/
#define ICMPV6_OPTION_TYPE_PREFIX_INFO_ON_LINK_FLAG     0x80
#define ICMPV6_OPTION_TYPE_PREFIX_INFO_AUTOMOUSK_FLAG   0x40
#define ICMPV6_OPTION_TYPE_PREFIX_INFO_INFINITE_TIMEOUT 0xFFFFFFFF

/*RFC6775. 4.2*/
#define ICMPV6_OPTION_TYPE_6CO_COMPRESSION_FLAG         0x10
#define ICMPV6_OPTION_TYPE_6CO_CID_MASK                 0x0F
#endif
...
/* Define the Source Link-Layer Address Option type. */

typedef struct NX_ICMPV6_OPTION_SLLAO_STRUCT
{

    /* Option type. */
    UCHAR nx_icmpv6_option_sllao_type;

    /* Option length. */
    UCHAR nx_icmpv6_option_sllao_length;

    /* Variable length Source Link-Layer Address. */
    UCHAR nx_icmpv6_option_sllao_slla[8];

    /* Unused field. This field is not present if the option length is 1. */
    USHORT nx_icmpv6_option_sllao_reserved1;

    /* Unused field. This field is not present if the option length is 1. */
    ULONG nx_icmpv6_option_sllao_reserved2;

}NX_ICMPV6_OPTION_SLLAO;

/* Define the 6LOWPAN Context option type. RFC6775 4.2*/
typedef struct NX_ICMPV6_OPTION_6CO_STRUCT
{

    /* 6CO type. */
    UCHAR nx_icmpv6_option_6co_type;

    /* option length. */
    UCHAR nx_icmpv6_option_6co_optionlength;

    /* Context prefix length. */
    UCHAR nx_icmpv6_option_6co_context_prefix_length;

    /* C Flag and CID  */
    UCHAR nx_icmpv6_option_6co_cflag_cid;

    /* Unused  */
    USHORT nx_icmpv6_option_6co_reserved;

    /* Valid life time, in seconds. */
    USHORT nx_icmpv6_option_6co_valid_lifetime;

    /* Context Prefix or address.*/
    ULONG nx_icmpv6_option_6co_prefix[4];

}NX_ICMPV6_OPTION_6CO;

/* Define the Address Registration Option type [RFC6775]. */

typedef struct NX_ICMPV6_OPTION_ARO_STRUCT
{
    /* Option type. */
    UCHAR nx_icmpv6_option_aro_type;

    /* Option length. */
    UCHAR nx_icmpv6_option_aro_length;

    /* Status. */
    UCHAR nx_icmpv6_option_aro_status;

    /* Reserved. */
    UCHAR nx_icmpv6_option_aro_reserved1;

    /* Reserved. */
    USHORT nx_icmpv6_option_aro_reserved2;

    /* Registration lifetime. */
    USHORT nx_icmpv6_option_aro_lifetime;

    /* 64-bit interface identifier of the registered address. */
    ULONG nx_icmpv6_option_aro_eui_64[2];

}NX_ICMPV6_OPTION_ARO;

/* Define the Authoritative Border Router Option type. RFC6775 4.3. */

typedef struct NX_ICMPV6_OPTION_ABRO_STRUCT
{

    /* Option type. */
    UCHAR nx_icmpv6_option_abro_type;

    /* Option length. */
    UCHAR nx_icmpv6_option_abro_length;

    /* Low 16 bits of the Version Number field. */
    USHORT nx_icmpv6_option_abro_version_low;

    /* High 16 bits of the Version Number field. */
    USHORT nx_icmpv6_option_abro_version_high;

    /* The length of time in units of 60 seconds that this information is valid. */
    USHORT nx_icmpv6_option_abro_valid_lifetime;

    /* IPv6 address of the 6LBR that is the origin of the included version number. */
    ULONG nx_icmpv6_option_abro_6lbr_address[4];

}NX_ICMPV6_OPTION_ABRO;
...
#ifndef NXDUO_DISABLE_ICMPV6_ROUTER_SOLICITATION
VOID _nx_icmpv6_send_rs(NX_IP *ip_ptr, UINT if_index, ULONG *dest_addr);
#endif 
...
VOID _nx_icmpv6_send_ns (NX_IP *ip_ptr, ULONG *neighbor_IP_address, int send_slla_aro, int registration_lifetime, NXD_IPV6_ADDRESS *outgoing_address, int sendUnicast);
