...
/*The maximum number of UUIDs in the UUID list  */
#ifndef SDP_MAX_UUID_ELEM_UUIDLIST
#define SDP_MAX_UUID_ELEM_UUIDLIST     16
#endif
...
#define HID_DEV_SUBCLASS            BTM_COD_MINOR_POINTING
#endif
