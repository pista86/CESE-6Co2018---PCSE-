...
/** @file
 * Defines WWD SDIO functions for PSoC6 MCU
 */
...
{
    /* TODO: Setup WiFi OOB interrupt GPIO pin (if required) for PSoC6 */
...
wwd_result_t host_platform_bus_init( void )
{
    ...
    /* TODO: Setup GPIO pin (if required) to put WLAN module into SDIO mode on PSoC6 */
