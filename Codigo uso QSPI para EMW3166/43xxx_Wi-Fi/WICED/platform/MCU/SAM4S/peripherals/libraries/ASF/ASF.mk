...
$(NAME)_CFLAGS += -Wno-error=expansion-to-defined
COMPILER_SPECIFIC_STANDARD_CFLAGS += -Wno-error=expansion-to-defined
COMPILER_SPECIFIC_PEDANTIC_CFLAGS += -Wno-error=expansion-to-defined
endif
