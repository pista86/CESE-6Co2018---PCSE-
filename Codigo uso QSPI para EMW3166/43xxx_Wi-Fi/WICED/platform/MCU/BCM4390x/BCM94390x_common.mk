...
GLOBAL_DEFINES += NORMAL_IMAGE_FLASH_BASE=$(NORMAL_IMAGE_FLASH_BASE)
GLOBAL_DEFINES += NORMAL_IMAGE_BOOTLOADER_START=$(NORMAL_IMAGE_BOOTLOADER_START)
GLOBAL_DEFINES += NORMAL_IMAGE_DCT_1_AREA_BASE=$(NORMAL_IMAGE_DCT_1_AREA_BASE)
GLOBAL_DEFINES += NORMAL_IMAGE_DCT_2_AREA_BASE=$(NORMAL_IMAGE_DCT_2_AREA_BASE)
GLOBAL_DEFINES += NORMAL_IMAGE_LUT_AREA_BASE=$(NORMAL_IMAGE_LUT_AREA_BASE)
GLOBAL_DEFINES += NORMAL_IMAGE_APPS_AREA_BASE=$(NORMAL_IMAGE_APPS_AREA_BASE)
GLOBAL_DEFINES += NORMAL_IMAGE_FS_AREA_BASE=$(NORMAL_IMAGE_FS_AREA_BASE)
endif # OTA2_SUPPORT
