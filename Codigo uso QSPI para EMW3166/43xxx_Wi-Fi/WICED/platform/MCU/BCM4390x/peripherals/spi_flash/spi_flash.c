...
int bcm4390x_sflash_init( sflash_handle_t* sflash_handle, void* peripheral_id, sflash_write_allowed_t write_allowed_in )
{
    ...
    interface = platform_interface_get( *( ( hw_interface_t *) peripheral_id ) );
            ...
            ( interface->sflash_handle_save->capabilities == NULL ) )
    {
        ...
        platform_interface_init( *( ( hw_interface_t *) peripheral_id ) );
        interface->sflash_handle_save->hw_interface = *( ( hw_interface_t *) peripheral_id );
