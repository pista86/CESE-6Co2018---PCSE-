...
typedef mbedtls_md5_hw_context     wiced_hw_md5_context;
typedef mbedtls_sha256_hw_context  wiced_hw_sha256_context;
typedef mbedtls_sha1_hw_context    wiced_hw_sha1_context;
...
int wiced_hw_des3_set2key_dec( wiced_hw_des_context *ctx, const unsigned char key[ MBEDTLS_DES_KEY_SIZE * 3 ] );
