...
static void prvAddNewTaskToReadyList( TCB_t *pxNewTCB )
{
	...
	taskENTER_CRITICAL();
	{
		...
		if( pxCurrentTCB == NULL )
		{
			...
			{
				/* Ensure that the externally-visible struct matches the real thing */
				configASSERT( ( sizeof(tskTCB) == sizeof(StaticTask_t) ) );
...
BaseType_t xReturn;
	...
	#if( (configSUPPORT_STATIC_ALLOCATION == 1) && (configSUPPORT_IDLE_TASK_STATIC_ALLOCATION == 1) )
	{
