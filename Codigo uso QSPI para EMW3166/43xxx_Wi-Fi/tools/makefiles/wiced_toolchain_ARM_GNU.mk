...
COMPILER_SPECIFIC_STANDARD_CFLAGS   = -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11 $(if $(filter yes,$(CYPRESS_INTERNAL) $(TESTER)),-Werror)
